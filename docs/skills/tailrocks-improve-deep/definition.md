---
title: "Tailrocks: tailrocks-improve-deep — Skill definition"
description: "Verbatim definition of tailrocks-improve-deep."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-deep/SKILL.md)
...
[`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-deep/references/runtime-trust.md) and
[`repository-audit-lanes.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-deep/references/repository-audit-lanes.md). This owner
