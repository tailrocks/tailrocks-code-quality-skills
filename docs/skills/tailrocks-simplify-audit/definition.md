---
title: "Tailrocks: tailrocks-simplify-audit — Skill definition"
description: "Verbatim definition of tailrocks-simplify-audit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify-audit/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify-audit/references/runtime-trust.md) and
[`simplification-ladder.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify-audit/references/simplification-ladder.md).
