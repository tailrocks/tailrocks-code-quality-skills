---
title: "Tailrocks: tailrocks-improve-security — Skill definition"
description: "Verbatim definition of tailrocks-improve-security."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-security/SKILL.md)
...
[`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-security/references/runtime-trust.md) and
[`security-rubric.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-improve-security/references/security-rubric.md). Return one report and
change nothing.
