---
title: "Tailrocks: tailrocks-simplify — Skill definition"
description: "Verbatim definition of tailrocks-simplify."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify/references/runtime-trust.md) and
[`behavior-preservation.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-simplify/references/behavior-preservation.md).
