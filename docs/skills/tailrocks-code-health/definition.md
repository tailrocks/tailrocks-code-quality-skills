---
title: "Tailrocks: tailrocks-code-health — Skill definition"
description: "Verbatim definition of tailrocks-code-health."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/runtime-trust.md) and
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/shared-version-policy.md). References are
...
| ------------------------------------------------ | ----------------------------- | --------------- |
| [`ratchet.toml`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/templates/ratchet.toml)         | project ratchet configuration | selected bound  |
| [`flaky-tests.toml`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/templates/flaky-tests.toml) | flake quarantine              | flake evidence  |
| [`DEFECT_LEDGER.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/templates/DEFECT_LEDGER.md) | defect-to-gate ledger         | defect evidence |
| [`renovate.json`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/templates/renovate.json)       | `renovate.json`               | version ratchet |
...
2. **Prove the precondition.** Read only the applicable references:
   [`architecture-and-docs.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/architecture-and-docs.md),
   [`ratchets-and-baselines.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/ratchets-and-baselines.md),
   [`defects-flakes-and-reports.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/defects-flakes-and-reports.md),
   [`verification-lanes.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/verification-lanes.md), or
   [`versions-and-dependencies.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/references/versions-and-dependencies.md).
...
3. **Select canonical bytes.** Copy an absent baseline artifact from
   [`templates/`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health/templates/) rather than reconstructing it. Preserve stronger
