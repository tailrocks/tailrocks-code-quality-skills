---
title: "Tailrocks: tailrocks-code-health-audit — Skill definition"
description: "Verbatim definition of tailrocks-code-health-audit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/runtime-trust.md),
[`shared-version-policy.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/shared-version-policy.md), and only the
...
2. **Inventory enforcement.** Map each relevant gate and exception to owner,
   ...
   Read [`architecture-and-docs.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/architecture-and-docs.md),
   [`defects-flakes-and-reports.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/defects-flakes-and-reports.md), or
   [`verification-lanes.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/verification-lanes.md) only when the
   selected class requires it.
3. **Measure the ratchet.** Apply
   [`ratchets-and-baselines.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/ratchets-and-baselines.md). Recompute
   ...
   [`versions-and-dependencies.md`](https://github.com/tailrocks/tailrocks-code-quality-skills/blob/main/skills/tailrocks-code-health-audit/references/versions-and-dependencies.md):
